...
(function() {
  ...
  async function subscribeRealtime() {
    ...
    // Usar Supabase Realtime via WebSocket directamente
    try {
      ...
      const channel = client
        ...
        .on('postgres_changes', {
          ...
          // Solo agregar si NO es el mensaje del propio contacto (ya lo agregamos optimista)
      ...
      console.warn('[ChatBotIA] Realtime failed (fallback a polling):', e)
      startPolling()
    }
  }
