...
<!-- ═══════════════════════════════════════════════════════════════
     MODIFICADO en RBAC sprint:
       - Menú filtrado por permisos (no por rol).
       - Nueva sección "Administración" con usuarios/roles/invitaciones/auditoría.
     ═══════════════════════════════════════════════════════════════ -->
...
const navItems: NavItem[] = [
  ...
  { to: '/admin/my-inbox',     label: 'Mi bandeja',   icon: '📥', permission: 'conversations.read' },
  ...
  { to: '/admin/knowledge',    label: 'Conocimiento', icon: '📚', permission: 'knowledge.read', section: 'Configuración' },
...
const visibleNavGrouped = computed(() => {
  ...
  groups.set('', [])  // sección sin título (primeros items)
